                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            ...
                            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('stocks') && 'bg-slate-900'}`}>

                                <NavLink end to="/" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('stocks') && 'hover:text-slate-200'}`}>
                                    <Link to="/stocks">
                                        <div className="flex items-center">
                                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                            ...
                                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Storage Handling</span>
                                        </div>
                                    </Link>
                                </NavLink>
                            </li>
                            ...
                            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('orders') && 'bg-slate-900'}`}>
                                <NavLink end to="/" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('orders') && 'hover:text-slate-200'}`}>
                                    <Link to="/orders">
                                        <div className="flex items-center">
                                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                            ...
                                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Order Handling</span>
                                        </div>
                                    </Link>
                            ...
                            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('messages') && 'bg-slate-900'}`}>
                                ...
                                <div className="flex items-center">
                                        ...
                                        <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Donation Handling</span>
                                    </div>
                                    </Link>
